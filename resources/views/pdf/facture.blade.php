...
/*# sourceMappingURL=bootstrap.css.map */
        ...
        <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <address>
                            ...
                            <h1>Facture n° {{ $vente->facture->numero }}</h1>
                            Date : {{ $datefr }}</p> 
                        </address>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <address>
                            <strong>{{ Crypt::decrypt($vente->client->nom) }} {{ Crypt::decrypt($vente->client->prenom) }}</strong>
                            {{ Crypt::decrypt($vente->client->rue) }},{{ Crypt::decrypt($vente->client->nrue) }}
                            {{ Crypt::decrypt($vente->client->localite->code_postal) }} {{ Crypt::decrypt($vente->client->localite->intitule) }}</p>
                            {{ Crypt::decrypt($vente->client->pays) }}
                ...
                <p>Total HTVA : {{ $totalht }}</p>
                <p>Total TVA : {{ $totaltva }}</p>
                <p>Total TVAC : {{ $totalttc }}</p>
        </div>             