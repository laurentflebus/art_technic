...
<div class="card">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-4">
            ...
            @if ($errors->has('reference'))
                <p class="alert alert-danger">{{ $errors->first('reference') }}</p>
            @endif
        </div>
        <div class="form-group col-md-4">
            ...
            <select id="delai" name="delai" class="form-control">
                ...
                <option>90 jours fin de mois</option>
                <option>120 jours fin de mois</option>
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" rows="3" name="remarque">{{ old('remarque') }}</textarea>
