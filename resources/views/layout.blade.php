        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="bg-light border-right" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    {{-- @if (auth()->check()) --}}
                    @auth
                        <a href="/accueil" class="list-group-item list-group-item-action bg-light">
                        ...
                        @if (auth()->user()->admin)
                            <a href="{{ URL::to('inscriptionAuthentification') }}" class="list-group-item list-group-item-action bg-light">
                            ...
                            <a href="{{ URL::to('parametres/create') }}" class="list-group-item list-group-item-action bg-light">
                        ...
                        <a href="{{ URL::to('ventes') }}" class="list-group-item list-group-item-action bg-light">
                            <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" d="M2.5 11.5A.5.5 0 0 1 3 11h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4A.5.5 0 0 1 3 7h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4A.5.5 0 0 1 3 3h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
                            </svg>
                            Listing ventes
                        </a>
                        <a href="{{ URL::to('ventes/create') }}" class="list-group-item list-group-item-action bg-light">
                        ...
                        <a href="{{ URL::to('parametres/edit') }}" class="list-group-item list-group-item-action bg-light">
                        ...
                        <a href="{{ URL::to('deconnexion') }}" class="list-group-item list-group-item-action bg-light">
                    ...
                    @else
                        <a href="{{ URL::to('/') }}" class="list-group-item list-group-item-action bg-light">
