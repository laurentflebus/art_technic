            ...
            <table id="table" class="table table-striped table-bordered">
                ...
                @foreach($clients as $client)
                    <tr>
                        ...
                        <td><a href="mailto:{{ Crypt::decrypt($client->email) }}">{{ Crypt::decrypt($client->email) }}</a> <br> {{ Crypt::decrypt($client->telephone) }} <br> {{ Crypt::decrypt($client->mobile) }} </td>
                        ...
                        <form action= "{{ URL::to('clients/' . $client->id) }}" method="post">
                                ...
                                {{-- Affiche le client de vente (utilise la méthode show avec la route GET /clients/{id}) --}}
                                <a class="btn btn-small btn-success" href="{{ URL::to('clients/' . $client->id) }}" title="Afficher le client">
                                ...
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
                                <button type="submit" class="btn btn-danger" onclick="return confirm('Êtes-vous sur de vouloir supprimer ce client ?')" title="Supprimer le client">
